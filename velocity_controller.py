...
class VelocityController:
    ...
    def control(self, desired_velocity, current_velocity, dt):
        ...
        return desired_attitude, desired_altitude
...
def main():
    ...
    desired_altitude = 0 # Hover at 1m
    ...
    outer_loop_freq = 10   # Outer loop at 50 Hz
    ...
    while simulation_app.is_running():
        ...
        if outer_loop_counter % (inner_loop_freq // outer_loop_freq) == 0:
            # Outer loop velocity control
            desired_attitude, desired_altitude = vel_controller.control(
